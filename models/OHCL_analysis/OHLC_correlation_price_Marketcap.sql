...
SELECT 
    ...
    (c.MARKET_CAP - LAG(c.MARKET_CAP) OVER (PARTITION BY c.CRYPTO_ID ORDER BY c.TRADE_DATE)) / NULLIF(LAG(c.MARKET_CAP) OVER (PARTITION BY c.CRYPTO_ID ORDER BY c.TRADE_DATE), 0) * 100 AS MARKET_CAP_CHANGE_PERCENTAGE
